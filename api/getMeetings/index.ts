...
export default async function run(
  ...
  try {
    ...
    if (currentUser && currentUser.displayName) {
      ...
      req.query.userId = currentUser.preferredUserName;
    } else {
  ...
  try {
    ...
    */
    ...
    res.body.meetings = await sqlService.getMeetings(req.query.userId);
    console.log(res.body.meetings);
      ...
      meetings: [
        {
          ...
          EndTime: "2022-04-20T14:30",
          AttendeeCount: 5,
          SavedEmission: 250,
          City: "Berlin, Germany",
          PositionLon: 12.9857,
          PositionLat: 8.3214,
          OrganizerID: "me@geek.onmicrosoft.com",
          CalculationStatus: "success"
        },
        {
          ID: "7",
          OnlineMeetingID: "AAMkAGMzMzFiMzEyLTYyMmMtNDRmYS05NzI0LWU5MWNjZmE4ODhmNwBGertAAAAG4jlHIKdjTbhtIugUrtoYBwBwtVOUUy6tSYeOqZkyKpeWAAAAAAENAABwtVOUUy6tSYeOqZkyKpeWAAc2gMvJAAA=",
          StartTime: "2022-04-19T13:30",
          EndTime: "2022-04-19T14:30",
          AttendeeCount: 5,
          SavedEmission: 300,
        ...
        {
          ID: "9",
          OnlineMeetingID: "AAMkAGMzMzFiMzEyLTYyMmwerzdfghdfhI0LWU5MWNjZmE4ODhmNwBGertAAAAG4jlHIKdjTbhtIugUrtoYBwBwtVOUUy6tSYeOqZkyKpeWAAAAAAENAABwtVOUUy6tSYeOqZkyKpeWAAc2gMvJAAA=",
          StartTime: "2022-04-19T13:30",
          EndTime: "2022-04-19T14:30",
          AttendeeCount: 7,
          SavedEmission: 280,
        ...
        {
          ID: "11",
          OnlineMeetingID: "AAMkAGMzMzFiMzEywertwetrwertw0LWU5MWNjZmE4ODhmNwBGertAAAAG4jlHIKdjTbhtIugUrtoYBwBwtVOUUy6tSYeOqZkyKpeWAAAAAAENAABwtVOUUy6tSYeOqZkyKpeWAAc2gMvJAAA=",
          StartTime: "2022-04-19T13:30",
          EndTime: "2022-04-19T14:30",
          AttendeeCount: 3,
          SavedEmission: 400,
